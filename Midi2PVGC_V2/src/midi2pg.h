...
public:
    ...
    void Begin(GateOutBank<NumVoices>* gates, CVOutBank<NumVoices>* cvOuts, LedOut* ledOut);
...
template<int NumVoices>
void Midi2PG<NumVoices>::Begin(GateOutBank<NumVoices> *gates, CVOutBank<NumVoices> *cvOuts, LedOut *ledOut)
{
    m_Gates = gates;
    m_LedOut = ledOut;
    m_CvOuts = cvOuts;
