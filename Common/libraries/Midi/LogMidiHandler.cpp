...
LogMidiHandler::LogMidiHandler(Serial &pc, int Id) : m_pc(pc), m_Id(Id)
{
...
void LogMidiHandler::NoteOn(uint8_t Channel, uint8_t MidiNote,
...
void LogMidiHandler::NoteOff(uint8_t Channel, uint8_t MidiNote,
                             uint8_t Velocity) /*override*/
{
